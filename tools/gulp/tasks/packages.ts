...
const packages = {
  'nestjs-config': createProject('packages/nestjs-config/tsconfig.json'),
  'nestjs-logger': createProject('packages/nestjs-logger/tsconfig.json'),
  'nestjs-prom': createProject('packages/nestjs-prom/tsconfig.json'),
  'nestjs-tracing': createProject('packages/nestjs-tracing/tsconfig.json'),
};
